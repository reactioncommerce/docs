...
You should understand the basics of how to create a plugin and generally how payments are handled
...
This function must query your external payment system and return an array of refund objects for a single payment. It can be an `async` function. If your payment method can't be refunded or there is no way to query for past refunds, you do not need to provide this function.
