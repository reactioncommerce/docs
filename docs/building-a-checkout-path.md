...
A checkout flow consists of a flow controller (some code that decides what step you are on and which steps are complete and incomplete) and several checkout step components. At the end of a checkout flow, your goal is to place a valid order using the `placeOrder` GraphQL mutation. This documentation goes in hand with the [Storefront guide](../guides/storefront-guide.md) to help you create a compelling experience in your storefront.
...
## Allow the user to choose a fulfillment option
